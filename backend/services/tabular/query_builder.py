...
from backend.services.tabular.query_templates import get_template, get_grouping_dimension_column
...
def build_query_plan(
    ...
    """
    from backend.services.tabular.resolver import sanitize_leading_number
