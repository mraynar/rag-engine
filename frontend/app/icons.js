// frontend/app/icons.js
// Reusable inline SVG icon components.
// Style: Feather / Lucide outline, strokeWidth ~1.75, currentColor, no fill.
// Props: size (number, default 16), className (string)
...
export function ChatIcon({ size = 40, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
